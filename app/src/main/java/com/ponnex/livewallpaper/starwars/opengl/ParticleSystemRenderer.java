package com.ponnex.livewallpaper.starwars.opengl;
...
import com.ponnex.livewallpaper.R;
...
public class ParticleSystemRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(context, R.raw.star_vert);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(context, R.raw.star_frag);
